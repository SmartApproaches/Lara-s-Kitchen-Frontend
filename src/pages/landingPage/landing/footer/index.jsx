...
//       {/* Polygon background */}
//       <div className="absolute top-0 -right-12 hidden h-full w-[55%] md:block">
//         <img
//           src={IMAGES.footerPolygon}
//           alt="Decorative Polygon"
//           className="h-full w-full object-cover"
//         />
//       </div>
//       <div className="absolute top-0 -right-12 h-full md:hidden">
//         <img
//           src={IMAGES.mobilePolyGon}
//           alt="mobilePolyGon"
//           className="h-full w-full object-cover"
//         />
//       </div>
...
//               <a className="flex h-9 w-9 items-center justify-center rounded-full bg-green-700">
//                 <img src={ICONS.facebookIcon} alt="Facebook" />
//               </a>
//               <a className="flex h-9 w-9 items-center justify-center rounded-full bg-green-700">
//                 <img src={ICONS.instagramIcon} alt="Instagram" />
...
//             <img src={IMAGES.phones} alt="App phone" className="mb-4 w-52 object-contain md:w-64" />
//             <img src={IMAGES.PlayStoreApple} alt="PlayStoreApple" className="w-44 md:w-56" />
//           </div> */}
//         </div>

//         {/* Bottom text */}
//         <div className="mt-10 text-center md:text-left">
//           <p className="text-sm text-gray-600">App and Website Developed by Smart Approaches</p>
//         </div>
//       </div>
//     </footer>
//   );
