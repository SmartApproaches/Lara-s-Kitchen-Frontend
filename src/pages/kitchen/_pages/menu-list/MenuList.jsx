...
} from "../../../../redux/slices/kitchen/kitchenmenuApiSlice";
import { Input, Button, Pagination, message } from "antd";
import MenuCard from "../../../cashier/_pages/dashboard/components/menuCard";
...
const KitchenMenuList = () => {
  ...
  const { data: categoryData } = useGetKitchenMenuCategoriesQuery();
...
export default KitchenMenuList;
